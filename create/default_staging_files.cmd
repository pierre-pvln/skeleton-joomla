...
IF NOT EXIST "README.md" (
	...
	ECHO.			 
	ECHO %extensionFolderName%\bld            folder with scripts to build the extension zipfile __git managed__
	ECHO.		 
	ECHO %extensionFolderName%\stg            folder with scripts to stage it to the update and download webserver ^<- THIS CODE __git managed__
	ECHO.
